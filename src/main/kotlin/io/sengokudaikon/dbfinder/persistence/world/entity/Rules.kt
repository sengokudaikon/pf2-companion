...
object Rules : KotlinxUUIDTable("rules") {
    ...
    val prompt = varchar("prompt", 255).nullable().default(null)
    val path = varchar("path", 255).nullable().default(null)
    val isArchived = bool("is_archived").default(false)
    val contentSrc = varchar("content_src", 255).nullable().default(null)
