...
import io.sengokudaikon.isn.compendium.domain.world.action.entity.ActionEffect
import io.sengokudaikon.isn.compendium.domain.world.action.entity.ActionTrait
import io.sengokudaikon.isn.compendium.domain.world.action.repository.ActionRepositoryPort
import io.sengokudaikon.isn.compendium.domain.world.effect.repository.EffectRepositoryPort
        ...
        return suspendedTransactionAsync {
            val action = Action.new {
                ...
                actionType = command.system.actionType.value.let {
                    if (it == "") {
                        return@let io.sengokudaikon.isn.compendium.enums.ActionTypes.NONE
                    } else {
                        return@let io.sengokudaikon.isn.compendium.enums.ActionTypes.valueOf(it.uppercase())
                    }
                }
                ...
                category = command.system.category.let {
                    if (it == "") {
                        return@let io.sengokudaikon.isn.compendium.enums.ActionCategories.NONE
                    } else {
                        return@let io.sengokudaikon.isn.compendium.enums.ActionCategories.valueOf(it.uppercase())
                    }
                }
                image = command.img
            }
